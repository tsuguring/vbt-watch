...
struct TrainingModelView: Identifiable {
    ...
    init(id: UUID = UUID(), objective: Objective, weight: Int, setCount: Int, sets: [SetModel], maxVelocityLoss: Int, date: Date) {
        self.id = id
